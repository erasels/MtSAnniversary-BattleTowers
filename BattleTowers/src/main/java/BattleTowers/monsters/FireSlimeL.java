...
public class FireSlimeL extends AbstractBTMonster {
    public static final String ID = makeID(FireSlimeL.class.getSimpleName());
    ...
    public FireSlimeL(final float x, final float y) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case SPLIT: {
                ...
                addToBot(new SpawnMonsterAction(new FireSlimeM(this.saveX - 134.0F, this.saveY +
    ...
    public void damage(DamageInfo info) {
        ...
        if ((!this.isDying) && (this.currentHealth <= this.maxHealth / 2.0F) && (this.nextMove != SPLIT) && (!this.splitTriggered)) {
            ...
            setMove(MOVES[SPLIT], SPLIT, AbstractMonster.Intent.UNKNOWN);
            createIntent();
            addToBot(new TextAboveCreatureAction(this, TextAboveCreatureAction.TextType.INTERRUPTED));
            addToBot(new SetMoveAction(this, MOVES[SPLIT], SPLIT, AbstractMonster.Intent.UNKNOWN));
