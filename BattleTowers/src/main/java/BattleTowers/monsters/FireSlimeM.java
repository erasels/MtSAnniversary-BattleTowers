...
public class FireSlimeM extends AbstractBTMonster {
    public static final String ID = makeID(FireSlimeM.class.getSimpleName());
    ...
    public FireSlimeM(final float x, final float y, int poisonAmount, int newHealth) {
        this(x,y);
    ...
    public FireSlimeM(final float x, final float y) {
        ...
        loadAnimation(BattleTowers.makeMonsterPath("fireSlimeM/skeleton.atlas"), BattleTowers.makeMonsterPath("fireSlimeM/skeleton.json"), 1.0F);
